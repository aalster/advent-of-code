...
//	static final String script = "";
	...
	public Object part1() {
		...
		OutputConsumer output = OutputConsumer.combine(outputBuffer, OutputConsumer.asciiPrinter(silent));
		...
		IntcodeComputer computer = new IntcodeComputer(program, input, output);
		computer.run();
